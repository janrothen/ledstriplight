...
from .effects import breathing_effect, fade_effect, random_color_effect, color_cycle_effect, FADE_PRESET_SNAPPY
...
class EffectRunner:
    ...
    def run_profile_effect(self, duration: int = 10000) -> None:
        ...
        self.strip.run_sequence(fade_effect, self.strip, Color.BLACK, color, duration, **FADE_PRESET_SNAPPY)
    ...
    def run_breathing_effect(self, color: Color = Color.RED, duration: int = 2000) -> None:
        ...
        self.strip.run_sequence(breathing_effect, self.strip, color, duration, **FADE_PRESET_SNAPPY)
    ...
    def run_cycle_effect(self, colors: Optional[List[Color]] = None, duration: int = 2000) -> None:
        ...
        self.strip.run_sequence(color_cycle_effect, self.strip, colors, duration, **FADE_PRESET_SNAPPY)
    ...
    def run_fade_effect(self, from_color: Color = Color.BLACK, to_color: Color = Color.WHITE, duration: int = 5000) -> None:
        ...
        self.strip.run_sequence(fade_effect, self.strip, from_color, to_color, duration, **FADE_PRESET_SNAPPY)